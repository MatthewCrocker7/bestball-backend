...
public class H2PgaDaoImpl implements PgaDao {
    ...
    //TODO: Come up with an on conflict option  for h2 instead of using delete
    ...
    private final String DELETE_COURSES = "DELETE FROM " + TOURNAMENT_COURSES + ";";
    private final String DELETE_ROUNDS = "DELETE FROM " + TOURNAMENT_ROUNDS + ";";
    ...
    public void updateTournamentSummary(TournamentSummary tournamentSummary) {
        ...
        // jdbcTemplate.update(DELETE_COURSES, courseParams[0]);
        jdbcTemplate.update(DELETE_ROUNDS, roundParams[0]);
